...
import com.zircky.industrialsorcerygreg.api.machine.multiblock.component.casing.IFieldGenData;
import org.jetbrains.annotations.NotNull;

public enum FieldGeneratorCasingType implements IFieldGenData {
  ...
  FIELD_GENERATOR_UXV("field_generator_uxv", 12),
  FIELD_GENERATOR_OPV("field_generator_opv", 13),
  FIELD_GENERATOR_MAX("field_generator_max", 14);

  private final String name;
  private final int tier;

  FieldGeneratorCasingType(String name, int tier) {
    this.name = name;
    this.tier = tier;
  }
