...
public class ISGMultiMachines {
  ...
  public final static MultiblockMachineDefinition ROCKET_ASSEMBLER = REGISTRATE
      ...
      .pattern(definition -> FactoryBlockPattern.start()
          ...
          .aisle("  AAAAABABAAAAA  ", "  ADCC     CCSA  ", "     C     C     ", "     C     C     ", "     C     C     ", "     C     C     ", "     C     C     ", "     C     C     ", "     C     C     ", "     C     C     ", "     C     C     ", "     C     C     ", "     C     C     ", "     C     C     ", "   CCCCCCCCCCC   ", "     C     C     ", "     C     C     ", "     C     C     ", "                 ", "                 ", "                 ", "                 ", "                 ", "                 ")
          ...
          .where('J', blocks(GTBlocks.CASING_STAINLESS_CLEAN.get()).or(autoAbilities(definition.getRecipeTypes()))
