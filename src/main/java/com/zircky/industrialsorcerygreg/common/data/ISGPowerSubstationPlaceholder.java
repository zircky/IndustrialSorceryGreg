...
public class ISGPowerSubstationPlaceholder {
  private static final BigInteger BIG_INTEGER_MAX_LONG = BigInteger.valueOf(Long.MAX_VALUE);

  public static void powerSubstationPlaceholder() {
    ...
    PlaceholderHandler.addPlaceholder(new Placeholder("psFillPercent") {
      ...
      public MultiLineComponent apply(
        ...
        if (capacity.signum() <= 0) {
          return MultiLineComponent.literal("§7Used Capacity: 0.000000%");
        }
        ...
        final MutableComponent label = Component.literal("§7Used Capacity: ");
