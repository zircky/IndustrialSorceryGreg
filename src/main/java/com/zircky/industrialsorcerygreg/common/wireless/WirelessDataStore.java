...
import static com.zircky.industrialsorcerygreg.common.wireless.GlobalWirelessVariableStorage.GlobalWirelessDataSticks;
...
public class WirelessDataStore {
  ...
  public static WirelessDataStore getWirelessDataStore(UUID uuid) {
    if (GlobalWirelessDataSticks.get(uuid) == null) GlobalWirelessDataSticks.put(uuid, new WirelessDataStore());
