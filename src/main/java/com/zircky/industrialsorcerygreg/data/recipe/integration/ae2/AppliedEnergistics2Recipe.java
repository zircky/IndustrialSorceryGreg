...
public class AppliedEnergistics2Recipe {
  ...
  private static void ae2Recipe(Consumer<FinishedRecipe> provider) {
    CENTRIFUGE_RECIPES.recipeBuilder(ISGCore.id("ae2/sky_dust_x1"))
        ...
        .circuitMeta(1)
        .chancedOutput(TagPrefix.dustSmall, GTMaterials.BasalticMineralSand, 1, 2000)
        .chancedOutput(TagPrefix.dustSmall, GTMaterials.Olivine, 1, 2000)
        .chancedOutput(TagPrefix.dustSmall, GTMaterials.Obsidian, 1, 2000)
        .chancedOutput(TagPrefix.dustSmall, GTMaterials.Basalt, 1, 2000)
        .chancedOutput(TagPrefix.dustSmall, GTMaterials.Flint, 1, 2000)
        .chancedOutput(TagPrefix.dustSmall, GTMaterials.RareEarth, 1, 2000)
    ...
    CENTRIFUGE_RECIPES.recipeBuilder(ISGCore.id("ae2/sky_dust_x9"))
        ...
        .circuitMeta(2)
        .chancedOutput(TagPrefix.dust, GTMaterials.BasalticMineralSand, 1, 9000)
        .chancedOutput(TagPrefix.dust, GTMaterials.Olivine, 1, 9000)
        .chancedOutput(TagPrefix.dust, GTMaterials.Obsidian, 1, 9000)
        .chancedOutput(TagPrefix.dust, GTMaterials.Basalt, 1, 9000)
        .chancedOutput(TagPrefix.dust, GTMaterials.Flint, 1, 9000)
        .chancedOutput(TagPrefix.dust, GTMaterials.RareEarth, 1, 9000)
