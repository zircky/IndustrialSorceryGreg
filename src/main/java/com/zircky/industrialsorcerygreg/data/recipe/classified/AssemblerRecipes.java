...
public class AssemblerRecipes {
  public static void init(Consumer<FinishedRecipe> provider) {
    GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder("space_nanomuscle_chestplate")
    ...
    GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder("space_advanced_nanomuscle_chestplate")
    ...
    GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder("space_quarktech_chestplate")
    ...
    GTRecipeTypes.ASSEMBLER_RECIPES.recipeBuilder("space_advanced_quarktech_chestplate")
